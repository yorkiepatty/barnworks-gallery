    ...
    def change_persona():
        ...
        try:
            ...
            if success:
                ...
                return jsonify({"success": True, "message": f"Persona changed to {new_persona}"})
            else:
...
__all__ = ['analyze_frame', 'register_eye_tracking_api', 'generate_ai_response', 'predict_outcome', 'get_input_analyzer']
