...
class LocalReasoningEngine:
    ...
    def install_model(self, model_name: str) -> bool:
        ...
        try:
            ...
            result = subprocess.run(["ollama", "pull", full_name], capture_output=True, text=True)
    ...
    def query_with_knowledge(self, question: str, domain: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        if relevant_knowledge:
            ...
            knowledge_context = "\n".join(
                [f"- {k['topic']}: {k['summary'][:200]}..." for k in relevant_knowledge[:5]]
            )
