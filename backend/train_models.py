...
def train_vocalization_model():
    ...
    logger.info(f"Vocalization classification report:\n{classification_report(y_test, y_pred)}")
...
def train_eye_movement_model():
    ...
    logger.info(f"Eye movement classification report:\n{classification_report(y_test, y_pred)}")
...
__all__ = ['train_gesture_model', 'train_vocalization_model', 'train_eye_movement_model', 'main']
