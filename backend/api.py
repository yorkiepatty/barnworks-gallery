...
class APIServer:
    ...
    def _register_routes(self):
        ...
        def store_memory():
            ...
            try:
                ...
                if self.conversation_engine and getattr(self.conversation_engine, "memory", None):
        ...
        def retrieve_memory():
            ...
            try:
                ...
                if self.conversation_engine and getattr(self.conversation_engine, "memory", None):
                    memories = self.conversation_engine.memory.retrieve(memory_type, limit)
        ...
        def get_avatar(state):
            """Get avatar image"""
            try:
                avatar_path = self.settings.MEDIA_DIR / "avatars" / f"avatar_{state}.png"
    ...
    def start(self, host=os.getenv("ALPHAVOX_HOST", "127.0.0.1"), port=8000):
