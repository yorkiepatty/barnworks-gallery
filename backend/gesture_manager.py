...
class GestureManager:
    ...
    def add_gesture(self, gesture: str, meaning: str, category: str = "Uncategorized") -> bool:
    ...
    def list_all_gestures(self) -> List[str]:
        return [gesture for cat in self.categories.values() for g in cat for gesture in g]
