...
class EnhancedSpeechRecognition:
    ...
    def process_audio_data(
        ...
        try:
            ...
            file_path = os.path.join(self.audio_cache_dir, f"audio_{timestamp}_{file_id}.wav")
            ...
            # Log the recognition
            self.logger.info(
                f"Audio processing result: '{recognized_text}' " f"(confidence: {confidence:.2f})"
            )
    ...
    def get_recognition_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "context": {
                ...
                "active_keywords_count": len(self.recognition_context["active_keywords"]),
            },
        }
...
__all__ = ['get_enhanced_speech_recognition', 'EnhancedSpeechRecognition']
