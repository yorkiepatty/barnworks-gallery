...
class NonverbalExpertise:
    ...
    def process_expertise_query(self, query: str) -> Dict[str, Any]:
        ...
        return {"error": "Topic not recognized. Please choose from: " + ", ".join(NONVERBAL_TOPICS)}
...
__all__ = ['get_nonverbal_expertise', 'process_expertise_query', 'get_random_fact', 'NonverbalExpertise']
